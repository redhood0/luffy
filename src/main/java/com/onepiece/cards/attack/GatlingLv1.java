...
public class GatlingLv1 extends CustomCard {
    ...
    public int customNumber1; // 自定义参数 1
    public int customNumber2; // 自定义参数 2
    ...
    public GatlingLv1() {
        ...
        this.customNumber1 = 6; // 初始化自定义参数 1
        this.customNumber2 = 3; // 初始化自定义参数 2
        this.rawDescription = DESCRIPTION + EXTENDED_DESCRIPTION[0] + this.customNumber1 + EXTENDED_DESCRIPTION[1] + this.customNumber2 + EXTENDED_DESCRIPTION[2];
...
//            this.upgradeMagicNumber(1);
            ...
            this.rawDescription = CARD_STRINGS.UPGRADE_DESCRIPTION + EXTENDED_DESCRIPTION[0] + this.customNumber1 + EXTENDED_DESCRIPTION[1] + this.customNumber2 + EXTENDED_DESCRIPTION[2];;
            this.initializeDescription();
        }
    }
...
//    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (ModHelper.HasEnoughElasticPower(AbstractDungeon.player, this.customNumber1)) {
            this.magicNumber += this.customNumber2; // 根据条件动态调整攻击次数
        }
