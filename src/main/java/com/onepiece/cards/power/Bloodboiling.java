...
import com.onepiece.powers.BloodboilingPower;
...
public class Bloodboiling extends CustomCard {
    ...
    private static final String IMG_PATH = "LuffyModRes/img/cards/Bloodboiling.png";//todo:改成橡胶果实icon
...
//            this.upgradeBlock(3);
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        //获得power
        this.addToBot(new ApplyPowerAction(p, p, new BloodboilingPower(p, this.magicNumber), this.magicNumber));
