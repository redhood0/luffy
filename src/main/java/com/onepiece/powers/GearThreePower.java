...
import static com.onepiece.tag.CustomTags.GEAR_3;
...
//        CardCrawlGame.sound.play("luffy:gear3",true);
        CardCrawlGame.sound.playV("luffy:gear3", 1.0f);    }
...
//        this.description = "sbsbsbsbs";
    ...
    public void onRemove() {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new SuperWeakPower(p, 2), 2));
        this.addToBot(new ApplyPowerAction(p, p, new SuperVulnerablePower(p, 2), 2));

        Texture newTexture = new Texture("LuffyModRes/img/char/luffy_gear3_s.png");
        AbstractDungeon.player.img = newTexture;
    }
